...
public class FormulaCell extends Cell
{
	public FormulaCell(String value)
	{
		...
		if (!value.startsWith("(") || !value.endsWith(")"))
			throw new IllegalArgumentException("Number values need to start and end with parenthesis. '" + value + "' did not.");
	}
	...
	{
		String result = super.getOriginalValue().substring(1, super.getOriginalValue().length()-1);
